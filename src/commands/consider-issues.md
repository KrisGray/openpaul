...
- STATE.md update on changes

### PAUL Adaptations
- **Directory:** `.paul/` instead of `.planning/`
- **UAT integration:** Also checks phase-scoped UAT files from /paul:verify
- **Loop closer framing:** Part of unify aspect - ensures issues don't stay orphaned
