...
<execution_context>
@~/.claude/openpaul-framework/workflows/consider-issues.md
</execution_context>

<context>
@.openpaul/ISSUES.md (if exists)
@.openpaul/STATE.md
@.openpaul/ROADMAP.md
</context>

<process>
**Follow workflow: @~/.claude/openpaul-framework/workflows/consider-issues.md**
