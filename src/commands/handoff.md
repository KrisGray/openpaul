...
Create `.openpaul/HANDOFF-{date}-{context}.md`:

```markdown
# OpenPAUL Session Handoff
...
**Resume:** `/openpaul:resume` then read this handoff
...
Saved: .openpaul/HANDOFF-{date}-{context}.md
...
Next session: /openpaul:resume → read handoff
════════════════════════════════════════
```
</step>
