...
**Distinction from /openpaul:discuss:** This command shows what CLAUDE thinks. The discuss command gathers what USER wants.
</objective>

<execution_context>
@~/.claude/openpaul-framework/workflows/phase-assumptions.md
</execution_context>
...
<process>
Follow workflow: @~/.claude/openpaul-framework/workflows/phase-assumptions.md
</process>
