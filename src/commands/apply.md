...
<execution_context>
@~/.claude/openpaul-framework/workflows/apply-phase.md
...
<step name="execute">
Follow workflow: @~/.claude/openpaul-framework/workflows/apply-phase.md
...
- Report: "APPLY complete. Run /openpaul:unify to close loop."
- Show files modified
...
- [ ] Next action clear (run /openpaul:unify)
</success_criteria>
