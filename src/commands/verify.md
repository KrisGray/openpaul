...
### Source Reference
- **GSD File:** `commands/gsd/verify-work.md`

### Adapted from GSD
- Thin wrapper pattern (command delegates to workflow)
- YAML frontmatter structure
- Optional argument for scope specification
- Anti-patterns section (user testing, no assumptions)
- Success criteria checklist format

### PAUL Adaptations
- **Directory structure:** References `.paul/phases/` instead of `.planning/phases/`
- **File naming:** Uses `{plan}-UAT.md` (PAUL convention)
- **Workflow reference:** Points to PAUL workflow at `~/.claude/paul-framework/workflows/verify-work.md`
- **Template reference:** Points to PAUL template `UAT-ISSUES.md`
