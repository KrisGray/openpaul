...
<execution_context>
@~/.claude/openpaul-framework/workflows/discuss-milestone.md
</execution_context>
...
@.openpaul/STATE.md
@.openpaul/ROADMAP.md
@.openpaul/MILESTONES.md
</context>

<process>
Follow workflow: @~/.claude/openpaul-framework/workflows/discuss-milestone.md
</process>

<success_criteria>
- [ ] MILESTONE-CONTEXT.md created with vision
- [ ] Key themes and goals articulated
- [ ] Ready for /openpaul:milestone command
</success_criteria>
