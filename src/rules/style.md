...
### Source Reference
- **GSD File:** `~/.claude/get-shit-done/.claude/rules/style.md`

### Adapted from GSD
- Language & Tone (imperative, no filler, no sycophancy)
- Temporal language ban
- Naming conventions table
- XML conventions (semantic tags, markdown headers within)
- @-reference patterns
- Commit format

### PAUL Adaptations
- **Command prefix:** `paul:` instead of `gsd:`
- **Phase directories:** Added `NN-kebab-name` pattern for `.paul/phases/`
- **Plan files:** Added `NN-NN-PLAN.md` naming pattern
- **Loop terminology:** Added PLAN/APPLY/UNIFY phase table (PAUL-specific)
- **Acceptance criteria:** Added Given/When/Then format section (PAUL innovation)
- **Temporal exception:** SUMMARY.md deviations instead of CHANGELOG.md
- **Removed:** Enterprise patterns ban (PAUL is already lean, redundant)
