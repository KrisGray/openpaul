...
- `execution_context`: Static resources (workflows, templates, references from OpenPAUL framework)
- `context`: Dynamic project state (from `.openpaul/` directory) and user arguments
