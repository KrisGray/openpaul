...
- **MCP integration:** Uses sonarqube MCP server tools
- **CONCERNS.md sync:** Auto-populates from scan results
- **Quality gates:** Objective pass/fail for code quality
- **Planning integration:** Quality informs phase planning
