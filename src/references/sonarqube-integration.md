...
Reference for integrating SonarQube code quality scanning with OpenPAUL.
...
Ensure sonarqube MCP is configured in OpenCode:
...
### Step 1: Enable in OpenPAUL Config

Edit `.openpaul/config.md`:
...
Or use OpenPAUL workflow:
```
/openpaul:quality-gate
```
...
## Integration with OpenPAUL

### CONCERNS.md Auto-Population

The quality-gate workflow updates `.openpaul/codebase/CONCERNS.md`:
...
- Configured in OpenCode settings
