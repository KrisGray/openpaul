...
OpenPAUL uses context brackets to adapt behavior based on remaining capacity:
...
@.openpaul/ROADMAP.md
@.openpaul/STATE.md
@.openpaul/phases/01-foundation/01-01-SUMMARY.md
@.openpaul/phases/01-foundation/01-02-SUMMARY.md
@src/models/user.ts
...
@.openpaul/phases/01-foundation/01-01-PLAN.md
@.openpaul/phases/01-foundation/01-01-SUMMARY.md
```
...
When context is exhausted or work spans sessions, OpenPAUL provides explicit handoff support.
...
Resume file: .openpaul/phases/03-references-layer/03-01-PLAN.md
Resume context:
...
### HANDOFF.md Document
For zero-context sessions or complex multi-session work. Created by `/openpaul:pause`:
...
| Command | Purpose |
|---------|---------|
| `/openpaul:pause` | Create HANDOFF, update STATE, prepare for break |
| `/openpaul:resume` | Restore context from HANDOFF/STATE, suggest next action |
| `/openpaul:progress` | Mid-session check, suggests ONE next action |
