...
<purpose>
Quality assurance patterns for research subagents. When OpenPAUL deploys subagents for research or discovery, this reference ensures findings are accurate, well-sourced, and actionable.
...
**Problem:** "Tool A supports X" ≠ "Tool B supports X"
