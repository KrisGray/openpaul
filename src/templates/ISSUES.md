...
Template for `.openpaul/ISSUES.md` — deferred enhancements discovered during execution.
...
**Location:** `.openpaul/ISSUES.md` (project-level, not phase-level)
...
2. Log to `.openpaul/ISSUES.md` with ISS-NNN format
