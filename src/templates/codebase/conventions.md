...
### Source Reference
- **GSD File:** `~/.claude/get-shit-done/templates/codebase/conventions.md`

### Adapted from GSD
- Template structure (Naming, Code Style, Imports, Error Handling, etc.)
- Good example with comprehensive patterns
- Guidelines for prescriptive documentation
- Analysis approach for detecting patterns

### PAUL Innovations
- Output path: `.paul/codebase/CONVENTIONS.md` (not `.planning/codebase/`)
- Consistent with PAUL's emphasis on explicit documentation
