...
### Source Reference
- **GSD File:** `~/.claude/get-shit-done/templates/codebase/architecture.md`

### Adapted from GSD
- Template structure (Pattern, Layers, Data Flow, Abstractions, Entry Points)
- Good example format with file path references
- Guidelines for conceptual vs physical documentation
- Analysis approach

### PAUL Innovations
- Output path: `.paul/codebase/ARCHITECTURE.md` (not `.planning/codebase/`)
- State management references `.paul/` directory
