...
Template for `.paul/codebase/TESTING.md` - captures test framework and patterns.
...
### Source Reference
- **GSD File:** `~/.claude/get-shit-done/templates/codebase/testing.md`

### Adapted from GSD
- Template structure (Framework, Organization, Structure, Mocking, etc.)
- Good example with comprehensive test patterns
- Guidelines for documenting actual vs ideal patterns
- Analysis approach for examining existing tests

### PAUL Innovations
- Output path: `.paul/codebase/TESTING.md` (not `.planning/codebase/`)
- Emphasis on verification criteria alignment with PAUL's verify requirements
