...
Template for `.paul/codebase/STACK.md` - captures the technology foundation.
...
### Source Reference
- **GSD File:** `~/.claude/get-shit-done/templates/codebase/stack.md`

### Adapted from GSD
- Template structure and sections
- Good example format
- Guidelines for what belongs/doesn't belong
- Analysis approach

### PAUL Innovations
- Output path: `.paul/codebase/STACK.md` (not `.planning/codebase/`)
- Analysis date format consistent with PAUL conventions
