...
Template for `.openpaul/codebase/STRUCTURE.md` - captures physical file organization.
...
**src/templates/**
- Purpose: Document templates for .openpaul/ files
...
- Source: Generated by `npx openpaul` CLI
