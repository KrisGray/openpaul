...
### Source Reference
- **GSD File:** `~/.claude/get-shit-done/templates/codebase/structure.md`

### Adapted from GSD
- Template structure (Directory Layout, Purposes, Key Locations, Conventions)
- ASCII tree format guidelines
- Good example with practical directory breakdown
- Guidelines for physical vs conceptual documentation

### PAUL Innovations
- Output path: `.paul/codebase/STRUCTURE.md` (not `.planning/codebase/`)
- References `.paul/` directory for project state
- Example uses PAUL command structure (src/commands/ not commands/gsd/)
