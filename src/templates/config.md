...
- **Config system:** Centralized project configuration
- **Integration toggles:** Enable/disable optional features
- **Extensible design:** Ready for future integrations
- **Separation of concerns:** Settings separate from state (STATE.md)
