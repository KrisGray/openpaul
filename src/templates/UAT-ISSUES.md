...
Template for `.openpaul/phases/XX-name/{phase}-{plan}-UAT.md` — issues discovered during user acceptance testing.
...
**Tested:** 2026-01-15
**Source:** .openpaul/phases/05-auth/05-02-SUMMARY.md
**Tester:** User via verify-work workflow
