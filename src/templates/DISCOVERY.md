...
### Source Reference
- **GSD File:** `get-shit-done/templates/discovery.md`

### Adapted from GSD
- Frontmatter structure (phase, topic, confidence)
- Objective and scope sections
- Option findings format (pros/cons/fit)
- Comparison table
- Open questions section
- Quality report with sources

### PAUL Innovations
- **Simplified structure:** Focused on decision-making, not protocol
- **Depth field:** Tracks which level was used
- **Ready for directive:** Clear next step at bottom
- **Assumptions section:** Explicit documentation of unverified items
