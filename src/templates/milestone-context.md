...
Template for `.openpaul/MILESTONE-CONTEXT.md` — temporary handoff from discuss-milestone to create-milestone.
...
**Generated:** {{DATE}}
**Status:** Ready for /openpaul:create-milestone
...
*This file is temporary. It will be deleted after /openpaul:create-milestone creates the milestone.*
...
## Integration with OpenPAUL Workflow
...
**Estimated phases:** 3
**Focus:** Complete milestone management tooling for OpenPAUL framework
