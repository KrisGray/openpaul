...
Template for `.openpaul/phases/{phase-number}-{name}/{phase}-{plan}-PLAN.md` - executable phase plans.
...
<!-- If .openpaul/SPECIAL-FLOWS.md exists, this section is auto-populated by /openpaul:plan -->
...
<output>
After completion, create `.openpaul/phases/XX-name/{phase}-{plan}-SUMMARY.md`
</output>
```
