...
### Source Reference
- **GSD File:** `get-shit-done/workflows/transition.md`

### Adapted from GSD
- Phase verification (PLAN count = SUMMARY count)
- PROJECT.md evolution (requirements validated/invalidated/emerged)
- Accumulated context review
- Milestone completion routing
- Cleanup stale handoffs

### PAUL Innovations
- **Quick continuation pattern:** `[1] Yes, plan next | [2] Pause here`
- **Invoked by unify:** Not a separate command, triggered automatically
- **Streamlined routing:** Fewer options, clearer default path
