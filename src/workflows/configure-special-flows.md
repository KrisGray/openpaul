...
### Adapted from GSD
- Conversational configuration pattern (from init-project)
- One question at a time flow

### PAUL Innovations
- **Skill discovery:** Scans ~/.claude/commands/ for available skills
- **Work type mapping:** Links skills to specific work categories
- **Priority levels:** Required vs optional enforcement
- **Phase overrides:** Per-phase skill customization
- **Subcommands:** add, audit, list for different use cases
