...
1. Check if .openpaul/config.md exists:
   ```bash
...
Update .openpaul/codebase/CONCERNS.md with scan results.
...
---
*Auto-generated by /openpaul:quality-gate*
...
Updated: .openpaul/codebase/CONCERNS.md
...
<output>
- Updated .openpaul/codebase/CONCERNS.md with SonarQube section
