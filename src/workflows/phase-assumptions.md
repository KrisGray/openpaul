...
### Source Reference
- **GSD File:** `get-shit-done/workflows/list-phase-assumptions.md`

### Adapted from GSD
- Purpose (surface assumptions before planning)
- Five assumption categories (technical, order, scope, risks, dependencies)
- Confidence levels (confident, assuming, unclear)
- Feedback gathering pattern
- Next steps offering

### PAUL Innovations
- **File references:** `.paul/ROADMAP.md` and `.paul/PROJECT.md`
- **Workflow name:** `phase-assumptions` (shorter than GSD's `list-phase-assumptions`)
- **Integration:** Ties directly to PAUL plan-phase workflow
- **No command syntax:** Workflow-focused, not command-focused
