...
### Source Reference
- **GSD File:** `get-shit-done/workflows/verify-work.md`

### Adapted from GSD
- Purpose (guide manual UAT)
- Process steps (identify through offer)
- Test checklist generation
- AskUserQuestion guidance pattern
- Issue severity classification
- Summary with verdict

### PAUL Innovations
- **AC-focused extraction:** Tests map directly to acceptance criteria
- **Directory:** `.paul/phases/` structure
- **File naming:** `{phase}-{plan}-UAT.md` instead of `-ISSUES.md`
- **Template reference:** `@src/templates/UAT-ISSUES.md`
- **AC field in issues:** Links issues back to specific acceptance criteria
