...
### Adapted from GSD
- Three depth levels with time estimates
...
### PAUL Innovations
- **No Context7:** Uses generic research subagents
- **Simpler source hierarchy:** Official docs + web search
- **Quality patterns integration:** References research-quality-control.md
- **Clear separation from research:** Discovery = decisions, Research = information
