...
### Source Reference
- **GSD File:** `commands/gsd/consider-issues.md`

### Adapted from GSD
- Issue file discovery pattern
- Issue parsing (ISS-NNN format)
- Codebase analysis for each issue
- Categorization (resolved/urgent/natural-fit/can-wait)
- Report format with sections
- Action offering pattern

### PAUL Innovations
- **UAT integration:** Includes phase-scoped UAT files from /paul:verify
- **Consolidated view:** Shows both ISS and UAT issues together
- **Loop closer framing:** Positioned as part of unify discipline
- **Decimal phases:** Uses PAUL's decimal phase convention for urgent work
