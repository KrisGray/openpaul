...
### Source Reference
- **GSD File:** `get-shit-done/workflows/discuss-milestone.md` (adapted for phases)

### Adapted from GSD
- Goals-first exploration pattern
- Context synthesis from discussion
- CONTEXT.md handoff creation
- Confirmation before writing context
- Handoff routing to next command

### PAUL Innovations Beyond GSD
- **Phase-level focus:** Operates on phases, not milestones
- **Distinct from assumptions:** Explicit separation of user input vs Claude analysis
- **Phase directory output:** Creates CONTEXT.md in phase directory
- **Roadmap integration:** Validates against and references ROADMAP.md
- **Anti-patterns section:** Explicit guidance on what NOT to do
