 ...
 */
export function formatHeader(level, text) {
 ...
 */
export function formatExecutionGraph(graph) {
 ...
 */
export function formatComparisonItems(items, emptyMessage = 'None') {
    if (!items.length) {
        return `- ${emptyMessage}`;
    }
 ...
 */
export function formatCriteriaResults(results) {
    if (!results.length) {
        return '- None';
    }
    return results
