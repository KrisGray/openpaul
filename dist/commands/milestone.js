...
export const paulMilestone = toolFactory({
    ...
    execute: async (args, context) => {
        try {
            ...
            const milestone = milestoneManager.createMilestone(args.name.trim(), args.scope.trim(), phaseNumbers, args.theme?.trim() || undefined);
 ...
 */
function formatMilestoneOutput(milestone, existingPhases) {
 ...
 */
async function updateStateMilestone(stateManager, milestoneName) {
